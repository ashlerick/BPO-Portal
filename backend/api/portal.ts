...
import { handler as menu } from '../lib/handlers/menu.js'
...
// notifications, the company calendar, user settings, and the
// admin-editable sidebar menu. vercel.json
...
export default requireAuth(async (req, res) => {
  ...
  if (resource === 'menu') return menu(req, res)
